...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Old Vinyl Collection DEV BUILD (PE 0.5.2h)", 12);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Brought to you by'], 15);
					#else
