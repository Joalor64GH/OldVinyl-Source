...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Old Vinyl Collection Team'],
			['Klimen3y',		'none',		'Director/Composer of the Mod',							'https://twitter.com/Shadow_Mario_',	'444444'],
			['Joalor64',			'none',		'Coder/Programmer of the Mod',						'https://twitter.com/RiverOaken',		'C30085'],
			[''],
			['Artists'],
